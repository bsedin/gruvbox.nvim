...
local function get_groups()
  ...
  local groups = {
    ...
    NERDTreeExecFile = { link = "GruvboxGreen" },
    ...
    -- NeoTreeDirSlash = { link = "GruvboxBlue" },
    -- NeoTreeOpenable = { link = "GruvboxOrange" },
    -- NeoTreeClosable = { link = "GruvboxOrange" },
    NeoTreeFileName = { link = "GruvboxFg1" },
    -- NeoTreeExecFile = { link = "GruvboxGreen" },
    -- NeoTreeUp = { link = "GruvboxGray" },
    NeoTreeRootName = { link = "GruvboxGreen" },
    -- NeoTreeHelp = { link = "GruvboxFg1" },
    -- NeoTreeToggleOn = { link = "GruvboxGreen" },
    -- NeoTreeToggleOff = { link = "GruvboxRed" },
    -- neotest
    NeotestPassed = { link = "GruvboxGreen" },
    NeotestRunning = { link = "GruvboxYellow" },
    NeotestFailed = { link = "GruvboxRed" },
    NeotestSkipped = { link = "GruvboxGray" },
    NeotestTest = { link = "GruvboxFg1" },
    NeotestNamespace = { link = "GruvboxPurple" },
    -- NeotestFocused = { link = "GruvboxGray" },
    NeotestFile = { link = "GruvboxFg1" },
    NeotestDir = { link = "GruvboxBlue" },
    NeotestBorder = { link = "GruvboxGray" },
    NeotestIndent = { link = "GruvboxGray" },
    NeotestExpandMarker = { link = "GruvboxGray" },
    NeotestAdapterName = { link = "GruvboxGray" },
    -- NeotestWinSelect = { link = "GruvboxGray" },
    NeotestMarked = { link = "GruvboxOrange" },
    NeotestTarget = { link = "GruvboxAqua" },
    -- NeotestUnknown = base.GruvboxGray
    -- coc.nvim
